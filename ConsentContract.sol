...
contract ConsentCode{
    ...
    function AccessData (address _address1,address _address2) view public returns (bool) { 
        ...
        if(objects[_address1].NoRestrictions==true) {
            ...
            (objects2[_address1].OpenToNonProfitUseOnly == false && (profit[_address2].UseForNonProfitPurpose == false && profit[_address2].UseForProfitPurpose == true &&
            person[_address2].UseByProfitMakingProfessionals == true))) &&
